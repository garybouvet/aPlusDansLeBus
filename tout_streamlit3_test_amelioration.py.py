...
# Get a copy of the original geodataframe to avoid mutating the cached object
gdf_original = load_data_and_create_geodataframe()
...
if selected == 'HOME':
    # Load the image
    image = Image.open('/Users/garybouvet/Desktop/Logo_A+_DansLeBus.png')
    ...
    # Create a new copy of the original geodataframe to avoid mutating the cached object
